...
const mutedSvg = `data:image/svg+xml;base64,${btoa('<svg xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 47 47" fill="none" stroke-width="3" stroke="#FFFFFF"><path stroke-linecap="round" stroke-linejoin="round" d="M32 28l9-9M41 28l-9-9M13 16l12-12v39l-12-12h-9v-15Z" /></svg>')}`;
const unmutedSvg = `data:image/svg+xml;base64,${btoa('<svg xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 47 47" fill="none" stroke-width="3" stroke="#FFFFFF"><path stroke-linecap="round" stroke-linejoin="round" d="M30.65685 29.15685A8 8 0 0 0 30.65685 17.84315M35.6066 34.1066A15 15 0 0 0 35.6066 12.8934M13 16l12-12v39l-12-12h-9v-15Z" /></svg>')}`;
